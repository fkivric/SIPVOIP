namespace MlSampleWindowCS
{
	partial class AboutForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "VoIP Video SIP SDK example application";
			// 
			// buttonOK
			// 
			this.buttonOK.Location = new System.Drawing.Point(236, 30);
			...
			this.label2.Text = "www.voipsipsdk.com";
			// 
			// AboutForm
			// 
